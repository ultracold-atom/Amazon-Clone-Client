                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="a-row a-spacing-small">
                            ...
                            <span class="a-size-small a-color-secondary">
                              <a href="#" class="a-link-normal a-text-normal">{{product.owner.name}}</a> <!--product.owner.name gelicek sonra-->
                            </span>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="a-row a-spacing-none">
                              ...
                              <span class="a-letter-space"></span>
                              <span class="a-size-base-plus a-color-secondary a-text-strike">$58.00</span>
                            </div>
...
export default {
  name: 'IndexPage',
  components:{Navbar,Footer,FeaturedProduct,StarRating},
